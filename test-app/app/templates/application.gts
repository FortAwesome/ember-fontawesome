...
// Deliberately not a real icon, so the demo can show the missing-icon warning.
const UNFINDABLE_ICON = 'unfindable-icon' as IconName;
...
class ApplicationRouteTemplate extends Component {
  ...
  <template>
    ...
    <h3>Default fas prefix versus specifying a different prefix for the same
      icon name</h3>
    <FaIcon @icon="square" />
    <FaIcon @prefix="far" @icon="calendar-xmark" />
    <h3>Missing Icon</h3>
    <p>Expecting no icon between these bars |<FaIcon
        @icon={{UNFINDABLE_ICON}}
    ...
    <h3>Pro Icon</h3>
    <p>(If you have pro-light-svg-icons installed, this should show the
      "starshp" &amp; "face-awesome" icons in the light style)</p>
    ...
    <p>(If you have pro-duotone-svg-icons installed, this should show the
      "starshp" &amp; "face-awesome" icons in the duotone style)</p>
    <FaIcon @prefix="fad" @icon="starship" @size="2x" />
    <FaIcon @prefix="fad" @icon="face-awesome" @size="2x" />
    <p>(If you have sharp-solid-svg-icons installed, this should show the
      starshp" &amp; "face-awesome"" icons in the solids style for the sharp
      family)</p>
    <FaIcon @prefix="fass" @icon="starship" @size="2x" />
    <FaIcon @prefix="fass" @icon="face-awesome" @size="2x" />
    <h3>Fixed Width</h3>

    <div><FaIcon @icon="home" @fixedWidth={{true}} class="MistyRose" />
      Home</div>
    <div><FaIcon @icon="info" @fixedWidth={{true}} class="MistyRose" />
      Info</div>
    ...
    <div><FaIcon @icon="cog" @fixedWidth={{true}} class="MistyRose" />
      Settings</div>
    <div><FaIcon @icon="fax" @fixedWidth={{true}} class="MistyRose" />
      Contact</div>

    <h3>List Icons</h3>
    <ul class="fa-ul">
      <li><span class="fa-li"><FaIcon @icon="check-square" /></span>List icons
        can</li>
